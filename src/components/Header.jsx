...
const Header = ({ cart, removeFromCart, decreaseQuantity, increaseQuantity, clearCart, carTotal})=>{
            ...
            <div className="carrito-container">
              <div className="carrito">
                ...
                <div id="carrito-content" className="carrito-content">                  
                  ...
                  <p className="text-end">Total a pagar: <span className="fw-bold">$ {carTotal.toLocaleString()}</span></p>
